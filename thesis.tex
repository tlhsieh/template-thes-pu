...
%%% Add line numbers, useful in the drafting stage for reviewers to comment on
\usepackage{lineno}
\linenumbers
...
%%% Citation style common in the field of AOS
...
% \bibliographystyle{unsrtnat} % natbib, unsorted
\bibliographystyle{plainnat} % natbib, sorted
